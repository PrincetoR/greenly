...
const ADMIN = ['/admin', '/admin/products', '/admin/products/new', '/admin/products/p-001', '/admin/categories', '/admin/promotions', '/admin/promotions/new', '/admin/promotions/promo-save100', '/admin/homepage', '/admin/orders', '/admin/shipping', '/admin/shipping?tab=settings', '/admin/payments', '/admin/payments?tab=settings', '/admin/users', '/admin/settings', '/admin/login'];
