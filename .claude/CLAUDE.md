...
- หน้ารายการสินค้า: หมวดหมู่เป็น **card แถบข้างซ้ายอย่างเดียว** (พี่ต่อเอาแบบ chip/tag ออก) บรรทัดแรก 'หมวดหมู่สินค้า' · หัวข้อหน้าอยู่เหนือช่องค้นหาในคอลัมน์ขวา · **แถบค้นหา sticky ใต้ header** (top-16, padding = gap การ์ด) · aside sticky top-20 · มือถือเป็น dropdown (`CategorySelect`)
