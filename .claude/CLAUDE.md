...
- **เส้นแนวตั้งร่วม**: `--aside-w` (220) / `--nav-item-w` (104) ใน globals.css — header คำนวณช่องโลโก้ = aside − 24 − nav-item ให้ขอบขวาเมนู "สินค้าทั้งหมด" ตรงขอบขวา card หมวดหมู่เป๊ะ (พี่ต่อ perfectionist — ห้ามแก้ค่าใดค่าหนึ่งโดยไม่ดูอีกค่า) · ชื่อร้านยาวเกิน ~90px จะโดน truncate
- หน้ารายการสินค้า: ไม่มีบรรทัดหัวข้อ (h1 sr-only) · card หมวดหมู่บรรทัดแรก "หมวดหมู่สินค้า" กึ่งกลางระดับข้อความช่องค้นหา · "ทั้งหมด" ขอบบนตรงขอบบนการ์ดสินค้า · padding บนหน้า 16px
