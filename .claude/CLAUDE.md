...
- **แถบสถานะบนสุด (แบบ Shopee, md+, ไม่ sticky)**: ซ้าย tagline · ขวา รายการโปรด (นับ) · ประวัติการสั่งซื้อ · ชื่อ login (username) หรือ `guest` → /account · พื้นขาว เส้นคั่นบาง ลิงก์เทา ชื่อเข้ม · ต้องเป็น snap point (`.status-bar`) ไม่งั้นโหลดมาโดน snap เลื่อนพ้นจอ
