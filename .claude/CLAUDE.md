...
- header ลูกค้ามุมขวา: **[บัญชี ▾] [ตะกร้า]** — ตะกร้าต้องอยู่ขวาสุดเสมอไม่มีอะไรมากั้น (พี่ต่อ: จุดสามจุดหลังตะกร้า "เหมือนกั้นรถเข็น") · AccountMenu = รูปคน+ลูกศรลง dropdown: โปรไฟล์ `/account` · รายการโปรด · ประวัติการสั่งซื้อ `/orders` · มือถือซ่อนปุ่มบัญชี ย้ายเข้า drawer
