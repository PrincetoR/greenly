...
- **sticky ตอนเลื่อน (จอ md+)**: card หมวดหมู่ (grid item เอง) + wrapper แถว [หัวข้อ ค้นหา เรียงลำดับ] ติดที่ `top-[65px]` (h-16 + border 1) · gap 16 บน/ล่างอยู่ใน wrapper (pt-4/pb-4) ให้เท่าตอนปกติ · พื้น `bg-page/85 backdrop-blur-sm` การ์ดมุดใต้แบบเบลอบาง ๆ (พี่ต่อ: อย่าให้แข็ง) · มือถือไม่ sticky
