...
- หน้ารายการสินค้า: แถวบน = [หัวข้อว่าเปิดอะไร + จำนวน … ช่องค้นหา · เรียงลำดับ] (ListingToolbar client: ค้นหาทันทีตอนพิมพ์ หน่วง 300ms ไม่มีปุ่ม · SortMenu dropdown เอง แสดง label สั้นบนปุ่ม) · **toolbar เป็น grid คอลัมน์เดียวกับกริดสินค้า**: lg หัวข้อ=การ์ด 1–2, ค้นหา=การ์ด 3→กึ่งกลางการ์ด 4 (`calc(75%+4px)`), เรียงลำดับ=ครึ่งหลังการ์ด 4 (e2e/11 ตรวจ) · card หมวดหมู่บรรทัดแรก "หมวดหมู่สินค้า" กึ่งกลางระดับแถวนี้ · เส้นคั่นที่ 40px · "ทั้งหมด" ขอบบนตรงขอบบนการ์ดสินค้า · padding บนหน้า 16px
