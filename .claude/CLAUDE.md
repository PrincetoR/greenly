...
- หน้าแรกด้านบน = **แบนเนอร์แบบ Shopee** (พี่ต่อขอ): card ขาว `p-3` เต็มคอนเทนเนอร์ (80–1200) ข้างใน grid `2fr_1fr` สูง 356 บน md+ — ซ้าย = สไลด์ใหญ่ (`slot: 'main'` เลื่อนเอง ข้อความมุมล่างซ้าย จุดมุมล่างขวา) ขวา = ภาพเล็ก 2 ช่องซ้อนแนวตั้ง (`slot: 'side'` 2 ใบแรกตามลำดับ นิ่ง คลิกได้) · มือถือ: สไลด์ 16:9 + ภาพเล็ก 2 คอลัมน์ข้างล่าง · ไม่มีภาพเล็ก = สไลด์เต็มการ์ด 8:3 · รูปแนะนำ 2:1 ทั้งคู่ (ไม่มีสไลด์ = ชื่อร้าน+สโลแกนแบบเดิม) · h1 ชื่อร้าน `sr-only` (e2e/07 นับ h1) · หัวข้อสไลด์เป็น `<p>` ไม่ใช่ h2 (e2e นับ `main h2` เป็นลำดับ section) · **ป๊อปอัปตอนเข้าเว็บ** เปิดเฉพาะ seed สาธิต (`enabled: WITH_HISTORY`) เพราะบังปุ่มที่ e2e กด · version เปลี่ยนทุกครั้งที่บันทึก → ลูกค้าที่ปิดแล้วเห็นใหม่
