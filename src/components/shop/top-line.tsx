...
/**
 * เส้นเขียว 2px ตรึงบนสุดของจอ (พี่ต่อสั่ง):
 *  · อยู่บนสุดของหน้า = กลืนไปกับแถบสถานะสีเดียวกัน · เลื่อนลงแถบสถานะพ้นจอ → เหลือเส้นเขียว 2px คาดบน header
...
export function TopLine() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-0 z-[60] h-0.5 overflow-hidden bg-brand" aria-hidden data-loading={loading || undefined}>
