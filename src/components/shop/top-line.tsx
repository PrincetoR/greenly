...
/**
 * เส้นเขียว 3px ตรึงบนสุดของจอ (พี่ต่อสั่ง — ลอง 2/6/4 แล้วเอา 3):
 *  · อยู่บนสุดของหน้า = กลืนไปกับแถบสถานะสีเดียวกัน · เลื่อนลงแถบสถานะพ้นจอ → เหลือเส้นเขียว 3px คาดบน header
...
export function TopLine() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 top-0 z-[60] h-[3px] overflow-hidden bg-brand" aria-hidden data-loading={loading || undefined}>
